...
export function KaKaoSignInButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="flex items-center w-full px-6 mt-4 text-xl font-semibold text-black transition-colors duration-300 bg-white border-2 border-black rounded-lg justify-left h-14 focus:shadow-outline hover:bg-slate-200"
    >
      <Image
        src={kakaologo}
        alt="Kakao Logo"
